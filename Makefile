...
push-service-py36:
	python deploy.py --dockerhub savvihub/kernels -t py36.full-cpu.jupyter service --push
	python deploy.py --dockerhub savvihub/kernels -t py36-cuda10.1.full-gpu.jupyter service --push
	python deploy.py --dockerhub savvihub/kernels -t py36-cuda11.0.full-gpu.jupyter service --push

push-service-py37:
	python deploy.py --dockerhub savvihub/kernels -t py37.full-cpu.jupyter service --push
	python deploy.py --dockerhub savvihub/kernels -t py37-cuda10.1.full-gpu.jupyter service --push
	python deploy.py --dockerhub savvihub/kernels -t py37-cuda11.0.full-gpu.jupyter service --push
